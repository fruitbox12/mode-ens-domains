...
contract NameRegistry is ERC721Enumerable, Ownable {
    ...
    /**
     * @dev Set a custom registration price for a specific name.
     * @param name The name for which to set the custom price.
     * @param price The custom registration price for the name.
     * @notice This function can only be called by the contract owner.
     */
    ...
    /**
     * @dev Internal function to check if an address is already registered.
    ...
    /**
     * @dev External function to check if an address is registered.
     * @param addr The address to check.
     * @return true if the address is registered, false otherwise.
     */
    ...
    /**
     * @dev Get the extension price for extending the registration of a name.
     * @param name The name for which to get the extension price.
     * @param numYears The number of years to extend the duration by.
     * @return The extension price in wei.
     */
